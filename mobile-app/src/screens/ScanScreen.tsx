...
export default function ScanScreen({ navigation }: any) {
  ...
  const handleCheckout = async () => {
    try {
      ...
      const totalDue = checkoutRes.data.summary.total_due;
        ...
        <View style={styles.cameraContainer}>
          ...
          <View style={styles.overlay}>
            <View style={styles.scanTarget}>
              ...
              {scanned && <ActivityIndicator size="large" color="#10b981" style={{marginTop: 100}} />}
            </View>
            <BlurView intensity={30} tint="dark" style={styles.scanInstruction}>
              <Ionicons name="scan" size={24} color="#10b981" style={{marginRight: 12}} />
...
const styles = StyleSheet.create({
  ...
  cameraIconBg: { width: 100, height: 100, borderRadius: 50, backgroundColor: 'rgba(59, 130, 246, 0.1)', justifyContent: 'center', alignItems: 'center', marginBottom: 24 },
  permissionTitle: { fontSize: 24, fontWeight: '800', color: '#fff', marginBottom: 12 },
  permissionText: { fontSize: 16, color: '#94a3b8', textAlign: 'center', marginBottom: 32, lineHeight: 24 },
  ...
  detailsCard: { borderRadius: 32, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', backgroundColor: 'rgba(15,23,42,0.6)' },
  cardHeader: { alignItems: 'center', padding: 32, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)' },
  ticketIconBg: { width: 64, height: 64, borderRadius: 32, backgroundColor: 'rgba(16, 185, 129, 0.1)', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
  cardTitle: { fontSize: 32, fontWeight: '900', color: '#fff', letterSpacing: 2, marginBottom: 12 },
  statusBadge: { backgroundColor: 'rgba(59, 130, 246, 0.2)', paddingHorizontal: 16, paddingVertical: 6, borderRadius: 20 },
  statusText: { color: '#60a5fa', fontWeight: '700', fontSize: 12, textTransform: 'uppercase', letterSpacing: 1 },
  
  detailsGrid: { flexDirection: 'row', flexWrap: 'wrap', padding: 24 },
  detailItem: { width: '50%', marginBottom: 24 },
  detailLabel: { color: '#94a3b8', fontSize: 13, fontWeight: '600', marginBottom: 4 },
  detailValue: { color: '#e2e8f0', fontSize: 16, fontWeight: '800' },
  
  feeContainer: { backgroundColor: 'rgba(16, 185, 129, 0.05)', padding: 24, alignItems: 'center', borderTopWidth: 1, borderBottomWidth: 1, borderColor: 'rgba(16, 185, 129, 0.1)' },
  feeLabel: { color: '#10b981', fontSize: 14, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
  feeValue: { color: '#10b981', fontSize: 48, fontWeight: '900' },
  feeSub: { color: 'rgba(16, 185, 129, 0.6)', fontSize: 12, marginTop: 4 },
  
  actions: { padding: 24, gap: 16 },
  button: { borderRadius: 16, overflow: 'hidden' },
  payBtn: { borderRadius: 16, overflow: 'hidden', shadowColor: '#10b981', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 8 },
