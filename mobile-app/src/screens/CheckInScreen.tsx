          ...
          <View style={styles.grid}>
            {VEHICLES.map(v => {
              ...
              return (
                ...
                >
                  <Ionicons name={v.icon as any} size={32} color={isActive ? '#fff' : '#64748b'} />
...
const styles = StyleSheet.create({
  ...
  label: { color: '#94a3b8', fontSize: 12, fontWeight: '800', marginBottom: 16, letterSpacing: 1 },
  
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 16 },
  typeBtn: { flex: 1, minWidth: '45%', backgroundColor: 'rgba(30, 41, 59, 0.7)', padding: 24, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', alignItems: 'center' },
  typeBtnActive: { backgroundColor: '#3b82f6', borderColor: '#60a5fa', shadowColor: '#3b82f6', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 8 },
  typeText: { color: '#94a3b8', fontWeight: '600', fontSize: 14, marginTop: 12 },
  typeTextActive: { color: '#fff', fontWeight: '700' },
  
  inputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(30, 41, 59, 0.7)', borderRadius: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', marginBottom: 24 },
  inputIcon: { paddingLeft: 16 },
  input: { flex: 1, color: '#fff', padding: 16, fontSize: 18, fontWeight: '700' },
  
  button: { borderRadius: 16, overflow: 'hidden', marginTop: 'auto' },
  ...
  ticketHoleLeft: { position: 'absolute', top: 180, left: -16, width: 32, height: 32, borderRadius: 16, backgroundColor: '#1e1b4b', zIndex: 10 },
  ticketHoleRight: { position: 'absolute', top: 180, right: -16, width: 32, height: 32, borderRadius: 16, backgroundColor: '#1e1b4b', zIndex: 10 },
  ticketHeader: { alignItems: 'center', marginBottom: 24 },
  ticketTitle: { fontSize: 24, fontWeight: '800', color: '#0f172a', marginTop: 8 },
  ...
  qrText: { color: '#64748b', fontWeight: '700', fontSize: 12, marginTop: 8 },
  ticketCode: { fontSize: 36, fontWeight: '900', color: '#0f172a', marginBottom: 24, letterSpacing: 4 },
  ...
  ticketLabel: { fontSize: 12, color: '#64748b', fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
  ticketValue: { fontSize: 18, color: '#0f172a', fontWeight: '800' },
});
