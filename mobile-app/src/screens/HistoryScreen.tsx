        ...
        <BlurView intensity={20} tint="dark" style={[styles.card, isActive ? styles.cardActive : null]}>
          <View style={styles.cardHeader}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              <View style={[styles.iconBox, { backgroundColor: isActive ? 'rgba(59, 130, 246, 0.2)' : 'rgba(16, 185, 129, 0.2)' }]}>
                <Ionicons name={item.vehicle_type === 'BIKE' ? 'bicycle' : 'car'} size={20} color={isActive ? '#3b82f6' : '#10b981'} />
              </View>
              <View>
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        {!loading && (
          <View style={styles.summaryContainer}>
            ...
            <View style={styles.summaryDivider} />
            <View style={styles.summaryCard}>
              <Text style={[styles.summaryValue, { color: '#fbbf24', fontSize: 16, marginTop: 4 }]}>
                Rs.{totalFare}
              </Text>
...
const styles = StyleSheet.create({
  ...
  emptyText: { color: '#64748b', marginTop: 16, fontSize: 16, fontWeight: '500' },
  
  cardWrapper: { marginBottom: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 5 },
  card: { borderRadius: 20, padding: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', backgroundColor: 'rgba(30, 41, 59, 0.4)' },
  cardActive: { borderColor: 'rgba(59, 130, 246, 0.3)', backgroundColor: 'rgba(30, 41, 59, 0.7)' },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  iconBox: { width: 40, height: 40, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
  plateText: { color: '#fff', fontSize: 16, fontWeight: '800', letterSpacing: 1 },
  ticketNumText: { color: '#94a3b8', fontSize: 12, fontWeight: '600', marginTop: 2, fontFamily: 'monospace' },
  
  badge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12, borderWidth: 1 },
  badgeActive: { backgroundColor: 'rgba(59, 130, 246, 0.1)', borderColor: 'rgba(59, 130, 246, 0.3)' },
  badgePaid: { backgroundColor: 'rgba(16, 185, 129, 0.1)', borderColor: 'rgba(16, 185, 129, 0.3)' },
  badgeText: { fontSize: 10, fontWeight: '800', letterSpacing: 0.5 },
  badgeTextActive: { color: '#60a5fa' },
  badgeTextPaid: { color: '#34d399' },
  ...
  summaryContainer: { flexDirection: 'row', backgroundColor: 'rgba(30, 41, 59, 0.6)', marginHorizontal: 20, borderRadius: 16, padding: 16, justifyContent: 'space-between', alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  summaryCard: { alignItems: 'center', flex: 1 },
  summaryValue: { fontSize: 20, fontWeight: '800', color: '#fff' },
  summaryLabel: { fontSize: 11, color: '#94a3b8', marginTop: 4, fontWeight: '600', textTransform: 'uppercase' },
