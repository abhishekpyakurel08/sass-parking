...
const styles = StyleSheet.create({
  ...
  header:           { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: sw(16), paddingVertical: sw(14), borderBottomWidth: 1, borderBottomColor: colors.border, backgroundColor: colors.card },
  headerTitle:      { color: colors.textSecondary, fontSize: sf(15), fontWeight: 'bold', letterSpacing: 1 },
  gateBadge:        { backgroundColor: colors.dangerBg, borderWidth: 1, borderColor: colors.danger, paddingHorizontal: sw(10), paddingVertical: sw(4), borderRadius: sw(8) },
  gateBadgeText:    { color: colors.danger, fontSize: sf(11), fontWeight: 'bold' },
  content:          { padding: sw(16), paddingBottom: sw(40) },
  card:             { backgroundColor: colors.card, borderRadius: sw(18), padding: sw(20), shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 12, elevation: 4 },
  cardTitle:        { color: colors.text, fontSize: sf(22), fontWeight: '800', marginBottom: 4, letterSpacing: -0.5 },
  cardSub:          { color: colors.textSecondary, fontSize: sf(13), marginBottom: sw(20) },
  fieldLabel:       { color: colors.textSecondary, fontSize: sf(11), fontWeight: '700', letterSpacing: 1, marginBottom: sw(8) },
  scanInputRow:     { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.inputBg, borderWidth: 1.5, borderColor: colors.border, borderRadius: sw(12), paddingHorizontal: sw(16), height: sw(52), marginBottom: sw(14) },
  scanInput:        { flex: 1, color: colors.text, fontSize: sf(17), fontFamily: 'monospace', fontWeight: '800', letterSpacing: 1 },
  primaryBtn:       { backgroundColor: colors.danger, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: sw(54), borderRadius: sw(14), marginBottom: sw(14), shadowColor: colors.danger, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 4 },
  primaryBtnText:   { color: '#FFF', fontSize: sf(14), fontWeight: '800', letterSpacing: 0.5 },
  lostLink:         { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: sw(6) },
  lostLinkText:     { color: '#FCA5A5', fontSize: sf(12), textDecorationLine: 'underline' },
  // Payment
  paymentHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: sw(20) },
  validatedBadge:   { backgroundColor: colors.success, paddingHorizontal: sw(10), paddingVertical: sw(6), borderRadius: sw(8) },
  validatedText:    { color: '#FFF', fontSize: sf(11), fontWeight: '800', letterSpacing: 0.5 },
  plateBox:         { backgroundColor: colors.accent, borderRadius: sw(12), padding: sw(14), alignItems: 'center', marginBottom: sw(18), shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
  plateText:        { color: colors.primary, fontSize: sf(26), fontWeight: '900', fontFamily: 'monospace', letterSpacing: 4 },
  timeRow:          { flexDirection: 'row', justifyContent: 'space-between', marginBottom: sw(10) },
  timeValue:        { color: colors.text, fontSize: sf(14), fontWeight: '800' },
  durationRow:      { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: sw(18), paddingBottom: sw(18), borderBottomWidth: 1, borderBottomColor: colors.border },
  totalDue:         { alignItems: 'center', marginBottom: sw(20) },
  totalDueValue:    { color: colors.success, fontSize: sf(48), fontWeight: '900', marginTop: sw(8), letterSpacing: -1 },
  methodToggle:     { flexDirection: 'row', backgroundColor: colors.inputBg, borderRadius: sw(12), borderWidth: 1.5, borderColor: colors.border, marginBottom: sw(20) },
  methodBtn:        { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: sw(6), padding: sw(13) },
  methodBtnActive:  { backgroundColor: colors.danger, borderRadius: sw(12) },
  methodText:       { color: colors.textSecondary, fontSize: sf(14), fontWeight: '700' },
  changeRow:        { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: colors.inputBg, borderWidth: 1.5, borderColor: colors.border, borderRadius: sw(12), paddingHorizontal: sw(16), height: sw(52), marginBottom: sw(20) },
  changeValue:      { color: colors.warning, fontSize: sf(20), fontWeight: '900' },
  // Modal
  overlay:          { flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'center', alignItems: 'center', padding: sw(16) },
  modal:            { backgroundColor: colors.card, borderRadius: sw(20), width: '100%', maxHeight: '85%', shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.12, shadowRadius: 24, elevation: 12 },
  modalHeader:      { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: sw(20), borderBottomWidth: 1, borderBottomColor: colors.border },
  modalTitle:       { color: colors.text, fontSize: sf(16), fontWeight: '800' },
  modalInput:       { backgroundColor: colors.inputBg, borderWidth: 1.5, borderColor: colors.border, borderRadius: sw(12), paddingHorizontal: sw(16), height: sw(52), marginBottom: sw(14) },
  modalInputText:   { color: colors.text, fontSize: sf(16), height: '100%', fontWeight: '700' },
  vehicleRow:       { flexDirection: 'row', flexWrap: 'wrap', gap: sw(8), marginBottom: sw(18) },
  vehicleChip:      { flexDirection: 'row', alignItems: 'center', gap: sw(6), paddingVertical: sw(10), paddingHorizontal: sw(14), borderWidth: 1.5, borderColor: colors.border, borderRadius: sw(12), backgroundColor: colors.inputBg },
  vehicleChipActive:{ backgroundColor: colors.primary, borderColor: colors.primary },
  vehicleChipText:  { color: colors.textSecondary, fontSize: sf(12), fontWeight: '700' },
});
